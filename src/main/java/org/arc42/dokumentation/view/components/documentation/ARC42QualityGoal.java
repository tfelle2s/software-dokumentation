...
public class ARC42QualityGoal extends Arc42NewDocumentationView{
    ...
    public void init() {
        ...
        getQualitaetsziele().getStyle().set(ElementConstants.STYLE_COLOR, "var(--lumo-primary-text-color)");
        ...
        qualityGoalG.addColumn(new ComponentRenderer<>(QualityGoalDTO::generateBadge)).setHeader("Kategorie");
        ...
        qualityGoalG.addSelectionListener((SelectionListener<Grid<QualityGoalDTO>, QualityGoalDTO>) selectionEvent -> {
        ...
        main.add(new BreadCrumbComponent(new String[]{"Einführung und Ziele","Qualitätsziele"}), qualityGoalG, qualityCriteria);
        add(main);
    }
}