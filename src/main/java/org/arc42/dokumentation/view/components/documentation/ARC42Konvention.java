...
public class ARC42Konvention extends Arc42NewDocumentationView {
    ...
    public void init() {
        ...
        edit.addClickListener((ComponentEventListener<ClickEvent<Button>>) event -> {
            ...
            clearTextFieldValue();
            updateList();
            new NotificationWindow("Konventionen erfolgreich geändert!", NotificationType.SHORT, NotificationType.SUCCESS);
        });
        ...
        delete.addClickListener((ComponentEventListener<ClickEvent<Button>>) event -> {
            ...
            clearTextFieldValue();
            updateList();
            new NotificationWindow("Konventionen erfolgreich gelöscht!", NotificationType.SHORT, NotificationType.NEUTRAL);
        });
