...
public class ARC42Technisch extends Arc42NewDocumentationView {
    ...
    public void init() {
        ...
        edit.addClickListener((ComponentEventListener<ClickEvent<Button>>) event -> {
            ...
            clearTextFieldValue();
            updateList();
            new NotificationWindow("Technische Randbedingung erfolgreich geändert!", NotificationType.SHORT, NotificationType.SUCCESS);
        });
        ...
        delete.addClickListener((ComponentEventListener<ClickEvent<Button>>) event -> {
            ...
            clearTextFieldValue();
            updateList();
            new NotificationWindow("Technische Randbedingung erfolgreich gelöscht!", NotificationType.SHORT, NotificationType.NEUTRAL);
        });
