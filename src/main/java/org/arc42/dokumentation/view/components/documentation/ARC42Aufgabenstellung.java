...
public class ARC42Aufgabenstellung extends Arc42NewDocumentationView {
    ...
    public void init() {
        ...
        edit.addClickListener((ComponentEventListener<ClickEvent<Button>>) event -> {
            ...
            goal.clear();
            updateList();
            new NotificationWindow("Aufgabe erfolgreich geändert!", NotificationType.SHORT, NotificationType.SUCCESS);
        ...
        delete.addClickListener((ComponentEventListener<ClickEvent<Button>>) event -> {
            ...
            goal.clear();
            updateList();
            new NotificationWindow("Aufgabe erfolgreich gelöscht!", NotificationType.SHORT, NotificationType.NEUTRAL);

        });

        VerticalLayout main = new VerticalLayout();
        main.setHorizontalComponentAlignment(Alignment.STRETCH, gridLayout);
        main.add(new BreadCrumbComponent(new String[]{"Einführung und Ziele", "Aufgabenstellung"}), gridLayout, goal, buttonLayout);
        add(main);
