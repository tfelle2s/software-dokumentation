...
public class StaticUtils {
    ...
    public static String getBadgeCategoryForClassNumber(String badgeClass) {
        return 	badgeClass.equals("1") ? "GoldBadge"
                : badgeClass.equals("2") ? "SilverBadge"
                : badgeClass.equals("3") ? "BronzeBadge" : null;
    }

    public static String getQuestionIdInRefLink(String refLink) throws NoValidStackOverflowLink {
        ...
        if (soId.matches(ONLY_NUMBERS)) {
            ...
            throw new NoValidStackOverflowLink("No valid StackOverflow-RefLink!");
        }
    }
