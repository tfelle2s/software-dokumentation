...
public class GraphBuilder   {
    ...
    public void createGraph(List<QualityDTO> qualityGoalDTOS) {
        ...
        for (QualityDTO quality: qualityGoalDTOS) {
            for (Object criteria:quality.getQualityCriteria()) {
                ...
                this.stack.push(new String[] {(String) criteria,badgeComponent.getBadge((String) criteria).getStyle().get("background-color")});
                ...
                if(quality instanceof QualityScenarioDTO) {
                    g.setEdgeWeight(relationshipEdge,((QualityScenarioDTO) quality).getWeight(((QualityScenarioDTO) quality).getRisk())
                            + ((QualityScenarioDTO) quality).getWeight(((QualityScenarioDTO) quality).getCurrentPriority()));
                    if (((QualityScenarioDTO) quality).getQualityGoalDTO() != null) {
                        g.addEdge((String) criteria, ((QualityScenarioDTO) quality).getQualityGoalDTO().toString(), new RelationshipEdge());
                        g.addEdge(((QualityScenarioDTO) quality).getQualityGoalDTO().toString(), quality.toString(), relationshipEdge);
                    } else {
    ...
    public String generateGraph(List<QualityDTO> qualityGoalDTOS) {
        ...
        while (!stack.isEmpty()) {
            ...
            for (Object o : nodes) {
                if (graphAdapter.getModel().isVertex(o) && graphAdapter.getLabel(o).equals(temp[0])) {
                    ...
                    graphAdapter.setCellStyles(mxConstants.STYLE_FILLCOLOR, temp[1], new Object[]{
                            vertex
                    });
                    graphAdapter.setCellStyles(mxConstants.STYLE_FONTCOLOR, "white", new Object[]{
                            vertex
                    });
                    graphAdapter.setCellStyles(mxConstants.STYLE_STROKECOLOR, temp[1], new Object[]{
                            vertex
                    });
                } else if(graphAdapter.getModel().isVertex(o) && graphAdapter.getLabel(o).startsWith("QS")) {
                    mxCell vertex = (mxCell) o;
                    graphAdapter.setCellStyles(mxConstants.STYLE_FILLCOLOR, "#5AFFA1", new Object[]{
                            vertex
                    });
                    graphAdapter.setCellStyles(mxConstants.STYLE_FONTCOLOR, "black", new Object[]{
                            vertex
                    });
                    graphAdapter.setCellStyles(mxConstants.STYLE_STROKECOLOR, "#5AFFA1", new Object[]{
                            vertex
                    });
                } else if(graphAdapter.getModel().isVertex(o) && graphAdapter.getLabel(o).startsWith("QZ")) {
                        mxCell vertex = (mxCell) o;
                        graphAdapter.setCellStyles(mxConstants.STYLE_FILLCOLOR, "#4DDBE3", new Object[]{
                                vertex
                        });
                        graphAdapter.setCellStyles(mxConstants.STYLE_FONTCOLOR, "black", new Object[]{
                            vertex
                     });
                        graphAdapter.setCellStyles(mxConstants.STYLE_STROKECOLOR, "#4DDBE3", new Object[]{
                                vertex
                        });
                }
            }
        ...
        Document document = mxCellRenderer.createSvgDocument(graphAdapter, null, 1.6, Color.WHITE,  null);
