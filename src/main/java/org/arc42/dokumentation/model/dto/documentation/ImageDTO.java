...
public class ImageDTO {
    ...
    public ImageDTO(String id, String bildName, String bildMimeType, byte[] bildPath, String uxfName, String uxfMimeType, byte[] uxfPath) {
    ...
    public ImageDTO(String id, String bildName, String bildMimeType, byte[] bildPath, String uxfName, String uxfMimeType, byte[] uxfPath, String description) {
        this.id = id;
        this.bildName = bildName;
        this.bildMimeType = bildMimeType;
        this.bildPath = bildPath;
