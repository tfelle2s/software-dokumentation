...
public class Arc42DocumentationDTO {
    ...
    public Boolean acceptedAlternativChange() {
        if (referencedAlternative.getId() != null && !referencedAlternative.getId().trim().isEmpty() && acceptedAlternative.getId() != null && !acceptedAlternative.getId().trim().isEmpty()) {
            return !referencedAlternative.getId().trim().equalsIgnoreCase(acceptedAlternative.getId().trim());
        } else if (referencedAlternative.getTitle() != null && !referencedAlternative.getTitle().trim().isEmpty() && acceptedAlternative.getTitle() != null && !acceptedAlternative.getTitle().trim().isEmpty()) {
            return !referencedAlternative.getTitle().trim().equalsIgnoreCase(acceptedAlternative.getTitle().trim());
        }
        return true;
    }
    ...
    public String toString() {
        return "Arc42DocumentationDTO{" + "arcId='" + arcId + '\'' + ", decisionId='" + decisionId + '\'' + ", referencedAlternative=" + referencedAlternative + ", acceptedAlternative=" + acceptedAlternative + ", rationaleId='" + rationaleId + '\'' + ", rationaleReferenz='" + rationaleReferenz + '\'' + ", rationaleBeschreibung='" + rationaleBeschreibung + '\'' + ", decisionTitle='" + decisionTitle + '\'' + '}';
    }
}
