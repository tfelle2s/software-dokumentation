...
public class GoogleBigQueryConnect {
    ...
    public String getAcceptedAnswerForQuestionId(String questionId) throws InterruptedException {
        ...
        String query = "SELECT q.accepted_answer_id AS AcceptedAnswerId" + System.lineSeparator() +
                " FROM `bigquery-public-data.stackoverflow.posts_questions` q" + System.lineSeparator() +
