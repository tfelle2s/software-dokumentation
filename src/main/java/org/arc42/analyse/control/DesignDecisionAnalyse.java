    ...
    public void startAnalyse() {
        ...
        if (count >= 1) {
            ...
            for (String rationaleId : rationaleIds) {
                ...
                dto.setRationaleBeschreibung(this.service.getRationaleBeschreibung(this.arcId, rationaleId));
                ...
                Arc42AlternativeDT0 referencedAlternative = new Arc42AlternativeDT0(this.service.getReferencedAlternativeId(dto.getDecisionId()), this.service.getReferencedAlternativeTitle(dto.getDecisionId()));
                ...
                if (dto.getRationaleReferenz().toLowerCase().contains("stackoverflow")) {
                    try {
                        ...
                        acceptedAlternative.setId(this.bigQueryConnect.getAcceptedAnswerForQuestionId(questionId));
                        dto.setAcceptedAlternative(acceptedAlternative);
                    } catch (InterruptedException | NoValidStackOverflowLink e) {
                        e.printStackTrace();
                    }
                } else if (dto.getRationaleReferenz().toLowerCase().contains("github")) {
                    String alternative = GithubDecisionParser.getAcceptedAlternative(dto.getRationaleReferenz());
...
//    public void setDtos(List<Arc42DocumentationDTO> dtos) {
//        this.dtos = dtos;
//    }
